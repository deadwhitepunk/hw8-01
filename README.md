# Домашнее задание к занятию "`Git`" - `Желонкин Дмитрий`
...
[`Ссылка на коммит`](https://github.com/deadwhitepunk/netology_git/commit/4b7b4c84a65f05d81fdb57d32b0a31b710b6987f)
...
[`Ссылка на коммит`](https://github.com/deadwhitepunk/netology_git/commit/e504fb9b478362a37fda9c99eaab56c620028ca1)
...
![Граф коммитов](https://github.com/deadwhitepunk/hw8-01/blob/main/img/image_exc3.png)`
...
![Граф коммитов](https://github.com/deadwhitepunk/hw8-01/blob/main/img/image_exc4.png)`